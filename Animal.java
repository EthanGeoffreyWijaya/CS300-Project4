...
public class Animal implements GUIListener {
  ...
  /**
   * Checks if the mouse is over the specified object
   * 
  ...
  /**
   * Sets isDragging to true if the Animal object is clicked and held.
   */
  @Override
  ...
  /**
   * Sets isDragging to false if the mouse is released from the Animal object.
   */
  @Override
  ...
  public boolean isClose(Animal otherAnimal, int range) {
    ...
    distance = distance(otherAnimal.getX(), otherAnimal.getY());
